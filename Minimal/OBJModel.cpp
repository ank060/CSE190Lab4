...
OBJModel::OBJModel(std::string modelPath) {
	toWorld = glm::mat4(1.0f);

	Assimp::Importer importer;
	const aiScene* pScene = importer.ReadFile(modelPath, aiProcess_Triangulate | aiProcess_FlipUVs);
...
void OBJModel::draw(GLuint shaderProgram, const glm::mat4& projection, const glm::mat4& view) {
